...
- Never adopt Tier-0 cache content (`Cache/Tier0/`), App key points, galaxy digests, or Apple Intelligence summaries as evidence. They may guide which verified claims or original pages to read; count Usage only for adopted verified evidence.
