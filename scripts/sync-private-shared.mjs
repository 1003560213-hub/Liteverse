...
const SHARED_PATHS = Object.freeze([
  ...
  "macos/LiteverseIntelligence.swift",
  "macos/LiteverseLocalWorker.swift",
  "public/liteverse-brand.png",
  "public/universe",
  "scripts/build-intelligence-helper.sh",
  "scripts/build-local-worker.sh",
  "scripts/build-macos-app.sh",
  "scripts/inline-desktop-assets.mjs",
  "scripts/install-codex-skills.sh",
  "scripts/lib",
  "scripts/liteverse-cli.mjs",
  "scripts/sync-private-shared.mjs",
  "scripts/validate-universe.mjs",
  "skills",
  "tests/curator-finalize.test.mjs",
  "tests/curator-review-adoption.test.mjs",
  "tests/curator-review-batch.test.mjs",
  "tests/desktop-app.test.mjs",
  "tests/galaxy-hierarchy.test.mjs",
  "tests/incremental-classification.test.mjs",
  "tests/layout-localization.test.mjs",
  "tests/linked-source-contract.test.mjs",
  "tests/liteverse-search-benchmark.test.mjs",
  "tests/local-preparation-contract.test.mjs",
  "tests/native-backup-validator.m",
  "tests/native-local-preparation-bridge.test.mjs",
  "tests/native-local-worker.test.mjs",
  "tests/native-workspace-contract.test.mjs",
  "tests/native-zotero-intake.test.mjs",
  "tests/nebula-expansion.test.mjs",
  "tests/performance-guards.test.mjs",
  "tests/runtime-logic.test.mjs",
  "tests/scientific-text.test.mjs",
  "tests/shared-code-sync.test.mjs",
  "tests/tier0.test.mjs",
